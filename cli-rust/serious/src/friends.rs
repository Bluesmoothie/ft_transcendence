...
use crossterm::{
    ExecutableCommand, QueueableCommand, cursor::{self, EnableBlinking, Hide, MoveLeft, MoveTo, SetCursorStyle, Show, position}, event::{self, Event, KeyCode, KeyEvent, KeyEventKind, poll}, style::*, terminal
};
...
async fn get_friends(game_main: &Infos) -> Result<()> {
